...
if (Test-Path -Path "C:\Program Files\RealVNC\VNC Viewer\vncviewer.exe")
{
...
{
	[System.Windows.MessageBox]::Show('Could Not Find VNCViewer.exe', 'Check EXE Present', 'OK', 'Error')
}